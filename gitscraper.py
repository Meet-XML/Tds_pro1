...
def main():
    ...
    # Search for users in Chennai with >100 followers
    users = scraper.search_users(location='Chennai', min_followers=51)
...
This repository contains data about GitHub users in Chennai with over 100 followers and their repositories.

## Files

1. `users.csv`: Contains information about {len(users)} GitHub users in Chennai with over 100 followers
